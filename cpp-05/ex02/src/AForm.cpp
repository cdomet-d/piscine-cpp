...
AForm::AForm(void)
	: name("Unset"), target("Unset"), signGrade(1), execGrade(1),
	  isSigned(false) {}

AForm::AForm(const std::string _name, const std::string _target,
			 const short int _signGrade, const short _execGrade)
	: name(_name), target(_target), signGrade(_signGrade),
	  execGrade(_execGrade), isSigned(false) {
