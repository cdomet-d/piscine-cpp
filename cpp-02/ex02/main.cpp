...
/*   Updated: 2024/08/26 15:40:30 by cdomet-d         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static void	testMinMax(void) {
	std::cout << std::endl << "| Non const MinMax |" << std::endl;
	{	
		Fixed a(3.0f);
		Fixed b(5.6f);
	...
	std::cout << std::endl << "| Const MinMax |" << std::endl;
	{
		const Fixed a(3.0f);
		const Fixed b(5.52f);
		std::cout << a << " | "<< b << " || Max is: " << Fixed::max(a, b) << std::endl;
...
static void	providedMain(void) {
	...
	std::cout << std::endl << "| Module provided main |" << std::endl;
	std::cout << a << std::endl;
	std::cout << ++a << std::endl;
	std::cout << a << std::endl;
	std::cout << a++ << std::endl;
